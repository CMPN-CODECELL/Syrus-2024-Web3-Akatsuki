      ...
      <section class="text-gray-400 bg-gray-900 body-font min-h-screen">
        <div class="container mx-auto flex px-10 py-12 md:flex-row flex-col items-center">
          <div class="lg:max-w-xl lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10">
            ...
            <img class="object-cover object-center rounded mb-20" alt="hero" src={homeimg}/>
          </div>
          <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 class="title-font text-5xl mb-10 font-medium text-purple-300 font-mono">GreenCrest Capital</h1>
            <p class="mb-3 leading-9 text-2xl text-purple-400 font-mono">Introducing "GreenCrest Capital", our blockchain-based DeFi platform that merges financial innovation with environmental and social impact. Experience transparent and accountable fund allocation through our smart contracts, empowering your investments to promote Green Job creation.</p>
            <p class="mb-5 leading-relaxed text-2xl text-purple-400 font-mono">Join us at Greencrest Capital, where financial growth meets a sustainable and socially responsible future.</p>
