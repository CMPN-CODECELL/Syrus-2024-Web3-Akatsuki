      ...
      <header class="text-gray-400 bg-gray-900 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <nav class="md:ml-auto items-center flex flex-wrap text-base justify-around">
            <Link to="/" class="mr-5 text-purple-300 hover:text-purple-500 font-mono text-2xl">HOME</Link>
            <Link to="/jobs" className="mr-5 text-purple-300 hover:text-purple-500 font-mono text-2xl">Green-Jobs</Link>
            <Link to="/steps" className="mr-5 text-purple-300 hover:text-purple-500 font-mono text-2xl">WALKTHROUGH</Link>
            <Link to="/upload" className="mr-5 text-purple-300 hover:text-purple-500 font-mono text-2xl">Dashboard</Link>
            
            <Link to="/team" className="mr-5 text-purple-300 hover:text-purple-500 font-mono text-2xl">TEAM</Link>
          </nav>
